...
import { ValidationPipe, HttpException, HttpStatus, Catch, ArgumentsHost, ExceptionFilter, Logger } from '@nestjs/common';
...
async function bootstrap() {
  if (!process.env.JWT_SECRET) {
    throw new Error('JWT_SECRET не задан. Укажите его в .env или в переменных окружения.');
  }
